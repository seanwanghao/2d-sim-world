...
function love.load()
    ...
    if love.filesystem.getInfo("SourceHanSansCN-Regular.otf") then
        font_small  = love.graphics.newFont("SourceHanSansCN-Regular.otf", 12)
        font_big    = love.graphics.newFont("SourceHanSansCN-Regular.otf", 16)
        font_rules  = love.graphics.newFont("SourceHanSansCN-Regular.otf", 10)
    else
